...
st.markdown("""
    ...
    html, body, [class*="css"], .stMarkdown, p, label { font-family: 'Hind Siliguri', sans-serif; color: #FFFFFF !important; font-weight: 600 !important; }
    div[data-testid="stWidgetLabel"] p { font-size: 1.2rem !important; color: #FFFFFF !important; }
    div.stButton > button { color: #FFFFFF !important; border: 2px solid #006A4E !important; background-color: rgba(0, 105, 78, 0.8) !important; font-weight: 700 !important; }
    div.stButton > button[kind="primary"] { background-color: #006A4E !important; color: #FFFFFF !important; }
    [data-testid="stSidebar"] { background-color: rgba(18, 18, 18, 0.9) !important; }
    .main-title { color: #FFFFFF !important; text-align: center; font-size: 2.2rem; font-weight: 700; border-bottom: 4px solid #F42A41; padding-bottom: 10px; }
    .section-head { background: #006A4E !important; color: #FFFFFF !important; padding: 10px 15px; border-radius: 8px; font-weight: 700; margin-top: 25px; border-left: 6px solid #F42A41; }
    div[data-baseweb="input"], div[data-baseweb="select"] { background-color: rgba(30, 30, 30, 0.9) !important; border: 1px solid #006A4E !important; border-radius: 8px !important; color: #FFFFFF !important; }
    div[data-baseweb="input"] input, div[data-baseweb="select"] select { color: #FFFFFF !important; }
    ...
    .stAlert { background-color: rgba(30, 30, 30, 0.9) !important; color: #FFFFFF !important; }
    .stSpinner > div > div { color: #FFFFFF !important; }
    /* Ensure Plotly charts have dark theme */
    .js-plotly-plot .plotly { background-color: #121212 !important; color: #FFFFFF !important; }
    .js-plotly-plot .plotly .modebar { background-color: #121212 !important; }
    /* Dataframe dark theme */
    [data-testid="stDataFrameResizable"] { background-color: #1E1E1E !important; color: #FFFFFF !important; }
    [data-testid="stDataFrameResizable"] th, [data-testid="stDataFrameResizable"] td { border-color: #333333 !important; color: #FFFFFF !important; }
    </style>
...
def main():
    ...
    st.markdown("<div style='text-align: center; margin-bottom: 30px; margin-top: 5px;'><p style='font-size: 1.2rem; color:#FFFFFF; background: rgba(18,18,18,0.5); display: inline-block; padding: 2px 15px; border-radius: 20px;'>বাংলাদেশ কম্পিউটার কাউন্সিল (BCC)</p></div>", unsafe_allow_html=True)
            ...
            if df_admin.empty:
                ...
                if show_stats:
                    ...
                    if total_vills > 0:
                        ...
                        # Update Plotly figure for dark mode
                        fig_pie.update_layout(paper_bgcolor="#121212", font_color="#FFFFFF")
                    ...
                    fig_bar = px.bar(div_counts, x='Division', y='Count', text_auto=True, color_discrete_sequence=['#006A4E'])
                    fig_bar.update_layout(paper_bgcolor="#121212", plot_bgcolor="#1E1E1E", font_color="#FFFFFF")
